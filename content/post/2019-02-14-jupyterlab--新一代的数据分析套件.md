---
title: "jupyterlab: 新一代的数据分析套件"
author: William
date: 2019-02-14
lastmod: 2019-02-14
categories: [Programming]
tags: [python,IDE,jupyterlab,数据分析,data science]
description: jupyterlab 是対 ipython notebook 的全新改良版，提供了一个基于网页的功能套件，集成了多种数据分析工具，如 python、R、Julia 的内核。 
draft: false
ToC: true
---
