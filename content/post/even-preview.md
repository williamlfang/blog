...
![hugo even showcase](/images/showcase.png "showcase.png")

带标题的图片，如下图👇

{{% figure src="/images/showcase.png" alt="hugo even showcase" title="showcase.png" %}}
...
{{% web website="http://seankross.com/the-unix-workbench/" title="The Unix Workbench"%}}
