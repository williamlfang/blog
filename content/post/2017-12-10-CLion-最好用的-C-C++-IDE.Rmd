---
title: "CLion：最好用的 C-C++ IDE"
author: William
date: 2017-12-10
lastmod: 2017-12-10
categories: [Programming]
tags: [Cpp, IDE]
description: CLion 是当前最好用的一款 c/cpp 的 IDE，真的没有之一。本文介绍如何安装并使用 CLion(2017.3)。
draft: false
ToC: true
---
...
![CLion 网页](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig01.png)
...
第一次打开 `CLion` 后，会出现一个界面询问是否需要导入偏好，通常我们不需要导入。

![不需要导入偏好设置](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig02.png)

接下来是激活软件，这个我们在后面的激活部分再解释，这里默认已经经过激活了。

![正在激活](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig03.png)

可以选择一款钟意的主题，我一般是使用暗色的编程主题，这里提供了 `Darcula`。

![不需要导入偏好设置](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig04.png)

设置 `C/Cpp` 的默认编译器，这里一般也不需要多做设置，等需要改变的时候再进行配置即可。

![设置编译器](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig05.png)

提供了可拓展的插件，可根据需要来选择安装

![选择安装插件](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig06.png)
...
![启动项目](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig07.png)

如果选择新建项目，我们需要做一个简单的配置

![新项目配置](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig08.png)

最好，我们终于可以愉快的写代码了。



![开始欢快的敲代码](/images/2017-12-10-CLion-最好用的-C-C++-IDE/fig09.png)
