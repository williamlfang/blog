    ...
    o.highlight=function(){
        for(var e = document.querySelectorAll("pre code"), n=0, e2=document.querySelectorAll("pre"); 
            ...
            {var t=e[n], t2 = e2[n], 
                ...
                for(var r=a.length,c="",i=0;i<r;i++) c+='<div class="line">'+(i+1)+"</div>";

                // for(var l="",s=0;s<r;
                //         s++)l+='<div class="line">'+a[s]+"</div>";
                //         t.className+=" highlight";

                // william
                // 增加 language- 为特定代码的类型
                for(var l="",s=0;
                        s<r;
                        s++)
                    l+='<div class="line">'+a[s]+"</div>";
                    t.className+=" highlight language-" + t2.className;

            var d=document.createElement("figure");

            d.className=t.className,d.innerHTML='<table><tbody><tr><td class="gutter"><pre>'+c+'</pre></td><td class="code"><pre>'+l+"</pre></td></tr></tbody></table>",o.parentElement.replaceChild(d,o)
            }
    },

    o.toc=function(){
        var e=document.getElementById("post-toc");if(null!==e){var n=document.getElementById("TableOfContents");null===n?e.parentNode.removeChild(e):(this._refactorToc(n),this._linkToc(),this._initToc())}
    },

    o._refactorToc=function(e){
        for(var n=e.children[0],t=n,o=void 0;1===t.children.length&&"UL"===(o=t.children[0].children[0]).tagName;)t=o;t!==n&&e.replaceChild(t,n)
    },
